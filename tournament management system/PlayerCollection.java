...
public class PlayerCollection {
     ...
     * @return either one of NO_ERROR, MAX_TEAM_REACHED, or MAX_PLAYERS_REACHED
     */
    ...
    public void loadPlayers(String file) throws IOException, ClassNotFoundException {
        ...
        ObjectInputStream inp = new ObjectInputStream(Files.newInputStream(Paths.get(file)));
    ...
    public final ArrayList<Team> getLeaderboards() {
        ...
        sorted.sort(new sortLeaderboard());
        return sorted;
    }
     ...
     */
    static class sortLeaderboard implements Comparator<Team> {
